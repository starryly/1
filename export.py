...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / '../yolov5-1/data/Pedestrian.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '../yolov5-1/runs/train/exp5/weights/best.pt', help='model.pt path(s)')
